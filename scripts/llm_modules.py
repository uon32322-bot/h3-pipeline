...
按品类给建议:
- 涂抹类 (口红/粉底/眼影/腮红): 中间 2 镜"膏体贴+涂抹", 一镜膏体贴下唇/颊, 一镜上唇/另一侧
- 折叠类 (四件套/毛巾/床品): 中间 2 镜"折叠+展开", 一镜折叠被套, 一镜平整展开抚平
- 穿戴类 (衣服/鞋子/包): 中间 2 镜"穿戴+展示", 一镜穿戴过程, 一镜转身展示
- 食品类 (零食/饮料): 中间 2 镜"开包装+品尝", 一镜撕开包装, 一镜品尝
- 数码类 (耳机/手机): 中间 2 镜"上手+操作", 一镜拿在手里, 一镜按键/触摸操作
